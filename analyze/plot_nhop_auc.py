...
def get_model_paths(data_name, plot_type):
    ...
    return {
        ...
        "3hop": f"{base_path}experiment_data/action_space/n_hop/3hop/10%/proposed_{plot_type}_auc.npy",
        "4hop": f"{base_path}experiment_data/action_space/n_hop/4hop/10%/proposed_{plot_type}_auc.npy",
        "5hop": f"{base_path}experiment_data/action_space/n_hop/5hop/10%/proposed_{plot_type}_auc.npy",
    }
...
def plot_auc(data_name, plot_type):
    ...
    for model, path in paths.items():
        ...
        is_main_model = model in ["2hop", "3hop", "4hop", "5hop"]
    ...
    # 保存
    save_path = f"../result/img/{data_name}/nhop/{plot_type}.png"
